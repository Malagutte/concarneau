...
module.exports = {
	...
	'facebookAuth' : {
		...
		'clientSecret' 	: process.env.FACEBOOK_SECRET || 'dummy-secret-for-dev', // your App Secret
	...
	'twitterAuth' : {
		...
		'consumerSecret' 	: process.env.TWITTER_SECRET || 'dummy-secret-for-dev',
		'accessToken'       : '2532814112-Ze8L0AZJ71j9roiGuBJ6KJP2jYx35mGuacpbe3P',
		'accessTokenSecret' : process.env.TWITTER_ACCESS_SECRET || 'dummy-secret-for-dev',
	...
	'googleAuth' : {
		...
		'clientSecret' 	: process.env.GOOGLE_SECRET || 'dummy-secret-for-dev',
		'refreshToken'  : process.env.GOOGLE_REFRESH_TOKEN || 'dummy-token-for-dev',
